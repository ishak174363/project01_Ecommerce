...
# payement system with SSLCSession
@login_required
def payment(request):
    ...
    store_id='abc655ed0d20cac2'
    API_key='abc655ed0d20cac2@ssl'
...
def complete(request):
    if request.method=='POST' or request.method=='post':
        ...
        if status=='VALID':
            ...
            messages.warning(request,f"Your Payment Failed! Try Again! Page will be Redirected after 5s")
